package com.minayimam.android.collage
...
//    private val VISIBLE_IMAGE_PATH_KEY = "visible image path key"
    ...
    private val CURRENTY_PHOTO_PATH_KEY = "current photo path key"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        currentPhotoPath = savedInstanceState?.getString(CURRENTY_PHOTO_PATH_KEY)
...
//        }
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        ...
        outState.putString(CURRENTY_PHOTO_PATH_KEY, currentPhotoPath)
